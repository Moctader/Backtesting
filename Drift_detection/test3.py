...
class BackTesting:
    ...
    def load_data(self, file_path):
        self.data = pd.read_csv(file_path, parse_dates=['timestamp'], index_col='timestamp').head(100)
    ...
    def fetch_actual_price(self, timestamp):
        ...
        try:
            ...
            timestamps = data.index[train_size + time_step + 1:]
            ...
            timestamps_repeated = np.repeat(self.timestamps, self.time_step)
